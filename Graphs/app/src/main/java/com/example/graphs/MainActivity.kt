...
import com.example.graphs.ui.main.MainFragment
...
class MainActivity : AppCompatActivity() {
    ...
    var yMin: Double = 0.0
    var yMax: Double = 0.0
    private var color_osey = 0xffff0000.toInt()
    private var color_graph = 0xffff0000.toInt()
    private var size_line = 10F
    var graph = false
    ...
    fun f2(x: Double) = sqrt(25 - 25 * x.pow(2) / 64)
    fun f3(x: Double) = -sqrt(25 - 25 * x.pow(2) / 64)
}